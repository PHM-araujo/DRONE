...
const long rAB             = 77000;  // 100k pot resistance between terminals A and B (valor esperado)
...
void setPotWiper(int addr, int pos) {
  ...
  pos = constrain(pos, 0, 255);            // Garante que o valor escolhido está entre 0 e 255
